...
class ReadingOrderPredictor:
    ...
    def _init_l2r_map(self, page_elems: List[PageElement]):
        # Body disabled (condition was always False) — maps stay empty.
        # Downstream consumers (r2l_map checks in _init_ud_maps, l2r_map
        # walks in _find_order) handle empty maps correctly.
        self.l2r_map = {}
        self.r2l_map = {}
