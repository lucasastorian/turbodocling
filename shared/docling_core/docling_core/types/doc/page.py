...
class BoundingRectangle(BaseModel):
    ...
    def width(self) -> float:
        ...
        return math.sqrt((self.r_x1 - self.r_x0) ** 2 + (self.r_y1 - self.r_y0) ** 2)

    @property
    def height(self) -> float:
        """Calculate the height of the rectangle."""
        return math.sqrt((self.r_x3 - self.r_x0) ** 2 + (self.r_y3 - self.r_y0) ** 2)
    ...
    def angle(self) -> float:
        ...
        if abs(delta_y) < 1.0e-3:
            ...
            angle = math.pi / 2.0 if delta_y > 0 else -math.pi / 2.0
        else:
    ...
    def angle_360(self) -> int:
        ...
        return round(self.angle / math.pi * 180)
    ...
    def to_bounding_box(self) -> BoundingBox:
        ...
        return BoundingBox.model_construct(
            l=left,
            b=bottom,
            r=right,
            t=top,
